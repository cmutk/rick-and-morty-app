...
import { Grid, Typography, CardActionArea, Divider,Collapse,Link } from '@material-ui/core';
    ...
    return (
        <>
         <Typography variant="body1" component="div">
            ...
            <CardContentListItem title1="Origin" title2={char.origin.name}/> 
              </Link>  
            </CardActionArea>
            </Grid>
            <Divider/>
            ...
            <CardActionArea > 
            <Link href={char.location.url} variant="body1" color="inherit">
            <CardContentListItem title1="Location" title2={char.location.name}/>
            </Link>
            </CardActionArea>
            </Grid>
            <Divider/>
            ...
            {episodes&& episodes.map(episode=>{
              return <CardContentListItem key={"ep"+episode.id} title1={episode.episode} title2={episode.name}/>
            }
            )
            }
          </Typography>
